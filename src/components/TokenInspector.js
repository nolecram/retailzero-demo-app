          ...
          >
            ...
            >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                ...
                <a
                  href="https://auth0.com/docs/tokens"
                  target="_blank"
                  rel="noopener noreferrer"
                  style={{
                    color: '#667eea',
                ...
                <a
                  href="https://auth0.com/docs/get-started/tokens/jwt-claims"
                  target="_blank"
                  rel="noopener noreferrer"
                  style={{
                    color: '#667eea',
                ...
                <a
                  href="https://auth0.com/docs/get-started/tokens/id-tokens"
                  target="_blank"
                  rel="noopener noreferrer"
                  style={{
                    color: '#667eea',
                ...
                <a
                  href="https://auth0.com/docs/manage-users/user-account-linking/link-user-accounts"
                  target="_blank"
                  rel="noopener noreferrer"
                  style={{
                    color: '#667eea',
